import { Cart, CartItem, Item, User } from "@/contexts/shared/infrastructure/prisma/client";
...
export class CartPrismaRepository implements CartRepository {
    ...
    private toCartEntity(cart: CartWithRelations): CartEntity {
        ...
        cartEntity.items = cart.items.map((i) => {
            const sellerUserRole = i.item.seller.role === "seller" ? UserRole.SELLER : UserRole.BUYER;
