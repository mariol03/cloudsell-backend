...
import { addSchema, removeSchema, checkoutSchema, getSchema } from "./cart.schemas";
import { AddToCartRouteInterface, RemoveFromCartRouteInterface, CheckoutRouteInterface, GetCartRouteInterface } from "./cart.routes-interfaces";
...
export const cartRoutes = async (fastify: FastifyInstance) => {
    ...
    fastify.post<CheckoutRouteInterface>('/checkout', { schema: checkoutSchema, onRequest: [authenticateMiddleware, authorizeRole([UserRole.BUYER])] }, checkoutController);
