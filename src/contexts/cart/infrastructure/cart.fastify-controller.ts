...
import {
    itemRepositoryPrismaSingleton,
    cartRepositoryPrismaSingleton,
} from "@shared/infrastructure/prisma-singletons";
...
export const addToCartController = async (
    ...
    try {
        ...
        if (error instanceof Error && error.message === "ItemNotFound")
...
export const removeFromCartController = async (
    request: FastifyRequest<{ Body: RemoveFromCartDto }>,
    reply: FastifyReply,
) => {
    try {
...
export const getCartController = async (
    request: FastifyRequest<{ Params: ListCartDto }>,
    reply: FastifyReply,
) => {
    try {
...
export const updateCartController = async (
    request: FastifyRequest<{ Body: UpdateCartDto }>,
    reply: FastifyReply,
) => {
    try {
